...
<html>
    ...
    element.innerHTML = pagerHtml;
		...
		<div class="row">
		<div class="col-md-12">
		<div><font id="myAccountDocText">Federal Forms Reports - <font id="myAccountDocCategory">Yearly</font></font></div>
		...
		<div id="YearlyFederalReportsFormsID" class="editUserProfile" style="display: none;">
		<a href="#"><font class="myAccountCurrentTab">&nbsp;Yearly&nbsp;</font></a> </div>
		...
		<h3 class="pending-head-text">Total yearly reports forms <span>: <b id="displayCount"></b>&nbsp;</span></h3>
		
		<div class="pendingfederal-box">				             
			<div class="table-wd-adjmnt">
			<display:table  id="insured_list"  class="tablesorter" name="yearlyFederalReportsInfoList">
        ...
        var count = '<c:out value="${yearlyFederalReportsCount}"/>';        
