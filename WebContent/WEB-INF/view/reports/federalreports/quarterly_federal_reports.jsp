...
<html>
    ...
    element.innerHTML = pagerHtml;
		...
		<div class="row">
		<div class="col-md-12">
		<div><font id="myAccountDocText">Federal Forms Reports - <font id="myAccountDocCategory">Quarterly</font></font></div>
		
		<div id="DailyFederalReportsFormsID" class="pending-federal-form" style="display: none;">
		<a href="dailyFederalReports"><font class="pendingfederal">&nbsp;Daily&nbsp;<font color="#00a9f1">-&nbsp;<c:out value="${dailyFederalReportsCount}"/>&nbsp;</font></font></a> </div>
		...
		<div id="QuarterlyFederalReportsFormsID" class="editUserProfile" style="display: none;">
		<a href="#"><font class="myAccountCurrentTab">&nbsp;Quarterly&nbsp;</font></a> </div>
		...
		<h3 class="pending-head-text">Total quarterly reports forms <span>: <b id="displayCount"></b>&nbsp;</span></h3>
		
		<div class="pendingfederal-box">				             
			<div class="table-wd-adjmnt">
			<display:table  id="insured_list"  class="tablesorter" name="quarterlyFederalReportsInfoList">
        ...
        var count = '<c:out value="${quarterlyFederalReportsCount}"/>';        
