...
<html>
    ...
    element.innerHTML = pagerHtml;
		...
		<div class="row">
		<div class="col-md-12">
		<div><font id="myAccountDocText">State Forms Reports - <font id="myAccountDocCategory">Monthly</font></font></div>
		...
		<div id="MonthlyStateReportsFormsID" class="editUserProfile" style="display: none;">
		...
		<div class="pendingfederal-box">				             
			...
			<display:table  id="insured_list"  class="tablesorter" name="monthlyStateReportsInfoList">
        ...
        var count = '<c:out value="${monthlyStateReportsCount}"/>';        
