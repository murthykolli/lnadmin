...
<html>
    ...
    element.innerHTML = pagerHtml;
		...
		<div class="row">
		<div class="col-md-12">
		<div><font id="myAccountDocText">State Forms Reports - <font id="myAccountDocCategory">Yearly</font></font></div>
		...
		<div id="YearlyStateReportsFormsID" class="editUserProfile" style="display: none;">
		...
		<div class="pendingfederal-box">				             
			...
			<display:table  id="insured_list"  class="tablesorter" name="yearlyStateReportsInfoList">
        ...
        var count = '<c:out value="${yearlyStateReportsCount}"/>';        
