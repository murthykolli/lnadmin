...
<html>
    ...
    element.innerHTML = pagerHtml;
		...
		<div class="row">
		<div class="col-md-12">
		<div><font id="myAccountDocText">State Forms Reports - <font id="myAccountDocCategory">Quarterly</font></font></div>
		
		<div id="DailyStateReportsFormsID" class="pending-federal-form" style="display: none;">
		<a href="dailyStateReports"><font class="pendingfederal">&nbsp;Daily&nbsp;<font color="#00a9f1">-&nbsp;<c:out value="${dailyStateReportsCount}"/>&nbsp;</font></font></a> </div>
		...
		<div id="QuarterlyStateReportsFormsID" class="editUserProfile" style="display: none;">
		...
		<div class="pendingfederal-box">				             
			...
			<display:table  id="insured_list"  class="tablesorter" name="quarterlyStateReportsInfoList">
        ...
        var count = '<c:out value="${quarterlyStateReportsCount}"/>';        
