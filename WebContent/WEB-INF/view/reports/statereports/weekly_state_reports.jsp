...
<html>
    ...
    element.innerHTML = pagerHtml;
		...
		<div class="row">
		<div class="col-md-12">
		<div><font id="myAccountDocText">State Forms Reports - <font id="myAccountDocCategory">Weekly</font></font></div>
		...
		<div id="WeeklyStateReportsFormsID" class="editUserProfile" style="display: none;">
		...
		<div class="pendingfederal-box">				             
			...
			<display:table  id="insured_list"  class="tablesorter" name="weeklyStateReportsInfoList">
        ...
        var count = '<c:out value="${weeklyStateReportsCount}"/>';        
