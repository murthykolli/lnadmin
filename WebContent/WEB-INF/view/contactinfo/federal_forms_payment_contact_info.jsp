<%--
	Document : federal_forms_payment_contact_info
...
<html>
    ...
    element.innerHTML = pagerHtml;
		...
		<div class="row">
		<div class="col-md-12">
		<div><font id="myAccountDocText">Payment Contact Information - <font id="myAccountDocCategory">Federal Forms</font></font></div>
		...
		<div id="FederalFormsPaymentContactInfoID" class="editUserProfile" style="display: none;">
		<a href="#"><font class="myAccountCurrentTab">&nbsp;Federal Payment&nbsp;</font></a> </div>
		...
		<h3 class="pending-head-text">Total number of federal forms payment users <span>: <b id="displayCount"></b>&nbsp;</span></h3>
		
		<div class="pendingfederal-box">				             
			<div class="table-wd-adjmnt">
			<display:table  id="insured_list"  class="tablesorter" name="federalFormsPaymentContactInfoList">
            <display:column style="width:50px;" property ="allFederalFormsCheckoutPaymentAndUserContactSavingId" title="Index"/>
            ...
            <display:column style="width:130px;" property ="formStatus" title="Type of Document &nbsp;" />
        ...
        var count = '<c:out value="${federalFormsPaymentContactInfoCount}"/>';        
