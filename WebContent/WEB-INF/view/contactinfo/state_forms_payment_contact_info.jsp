<%--
	Document : state_forms_payment_contact_info
...
<html>
    ...
    element.innerHTML = pagerHtml;
		...
		<div class="row">
		<div class="col-md-12">
		<div><font id="myAccountDocText">Payment Contact Information - <font id="myAccountDocCategory">State Forms</font></font></div>
		...
		<div id="StateFormsPaymentContactInfoID" class="editUserProfile" style="display: none;">
		<a href="#"><font class="myAccountCurrentTab">&nbsp;State Payment&nbsp;</font></a> </div>
		...
		<h3 class="pending-head-text">Total number of state forms payment users <span>: <b id="displayCount"></b>&nbsp;</span></h3>
		
		<div class="pendingfederal-box">				             
			<div class="table-wd-adjmnt">
			<display:table  id="insured_list"  class="tablesorter" name="stateFormsPaymentContactInfoList">            
            <display:column style="width:50px;" property ="allStateFormsCheckoutPaymentAndUserContactSavingId" title="Index"/>
            <display:column property ="userPaymentTransactionInfoSavingId" title="Reference ID &nbsp;"/>            
            ...
            <display:column property ="invoiceNum" title="Invoice Num &nbsp;" />
            <display:column property ="responseReasonText" title="Payment Status &nbsp;" />
            <display:column property ="formFedLegalname" title="Free Federal Name &nbsp;" />
            <display:column property ="registeredAgentPrice" title="Registered Agent Fee &nbsp;" />            
        ...
        var count = '<c:out value="${stateFormsPaymentContactInfoCount}"/>';        
