<%--
	Document : payment_transaction_contact_info
...
<html>
    ...
    element.innerHTML = pagerHtml;
		...
		<div class="row">
		<div class="col-md-12">
		<div><font id="myAccountDocText">Payment Contact Information - <font id="myAccountDocCategory">User Transaction</font></font></div>
		
		<div id="PrimaryContactInfoID" class="pending-federal-form" style="display: none;">
		<a href="primaryContactInfo"><font class="pendingfederal">&nbsp;User Contact&nbsp;<font color="#00a9f1">-&nbsp;<c:out value="${userPrimaryContactInfoCount}"/>&nbsp;</font></font></a> </div>
		...
		<div id="PaymentTransactionInfoID" class="editUserProfile" style="display: none;">
		<a href="#"><font class="myAccountCurrentTab">&nbsp;Payment Transaction&nbsp;</font></a> </div>
		...
		<h3 class="pending-head-text">Total number of transactions <span>: <b id="displayCount"></b>&nbsp;</span></h3>
		
		<div class="pendingfederal-box">				             
			<div class="table-wd-adjmnt">
			<display:table  id="insured_list"  class="tablesorter" name="userPaymentTransactionContactInfoList">            
            <display:column style="width:50px;" property ="userPaymentTransactionInfoSavingId" title="Reference &nbsp;"/>            
            <display:column property ="userName" title="User Name &nbsp;"/>
            <display:column property ="cardNumber" title="Card Number &nbsp;"/>
            <display:column property ="transactionNumber" title="Transaction Number &nbsp;" />
            <display:column property ="cardExpiryDate" title="Expiry Date &nbsp;" />            
            <display:column property ="amount" title="Amount &nbsp;" />
            <display:column property ="orderStatus" title="Payment Status &nbsp;" />            
            <display:column property ="authorizationCode" title="Authorization Code &nbsp;" />            
            <display:column property ="billingFirstName" title="Billing First Name &nbsp;" />
            <display:column property ="billingLastName" title="Billing Last Name &nbsp;" />
            <display:column property ="billingAddress" title="Billing Address &nbsp;" />
            <display:column property ="billingCity" title="Billing City &nbsp;" />
            <display:column property ="billingStateName" title="Billing State &nbsp;" />
            <display:column property ="billingZip" title="Billing Zip &nbsp;" />
            <display:column property ="shipingFirstName" title="Shipping First Name &nbsp;" />
            <display:column property ="shipingLastName" title="Shipping Last Name &nbsp;" />
            <display:column property ="shipingAddress" title="Shipping Address &nbsp;" />
            <display:column property ="shipingCity" title="Shipping City &nbsp;" />
            <display:column property ="shipingStateName" title="Shipping State &nbsp;" />
            <display:column property ="shipingZip" title="Shipping Zip &nbsp;" />
        ...
        var count = '<c:out value="${paymentTransactionInfoCount}"/>';        
