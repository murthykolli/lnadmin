<%--
	Document : sub_admin_inactive_users
...
<html>
    ...
    element.innerHTML = pagerHtml;
		...
		<div class="row">
		<div class="col-md-12">
		<div><font id="myAccountDocText">Sub Admin - <font id="myAccountDocCategory">Inactive Users</font></font></div>
		
		<div id="ActiveUsersID" class="pending-federal-form" style="display: none;">
		<a href="subAdminActiveUsers"><font class="pendingfederal">&nbsp;Active Users&nbsp;<font color="#00a9f1">-&nbsp;<c:out value="${activeUsersCount}"/>&nbsp;</font></font></a> </div>
		
		<div id="InactiveUsersID" class="editUserProfile" style="display: none;">
		<a href="#"><font class="myAccountCurrentTab">&nbsp;Inactive Users&nbsp;</font></a> </div>
		
		<div class="clearfix"></div>
		<div class="my-account-pending-stats">
		<form action="subAdminInactiveUserPermissions" name="subAdminUsers" id="Documentform" method="get">		
		<h3 class="pending-head-text">Total inactive users <span>: <b id="displayCount"></b>&nbsp;</span></h3>
		
		<div class="pendingfederal-box">				             
			<display:table  id="insured_list"  class="tablesorter" name="inactiveUsersSavingList">
		...
		<button class="white-bg-sub-but" type="submit" onclick="return orderInfo();" onMouseOver="document.getElementById('fedit-sub-but').src='resources/images/SSImgs/InactivePermissionMOImg.png';" onMouseOut="document.getElementById('fedit-sub-but').src='resources/images/SSImgs/ActivePermissionImg.png';" ><img id="fedit-sub-but" src="resources/images/SSImgs/ActivePermissionImg.png" alt=""><span class="butt-va-mid">Active Permissions</span></button> </h4>
        ...
        var count = '<c:out value="${inactiveUsersCount}"/>';        
