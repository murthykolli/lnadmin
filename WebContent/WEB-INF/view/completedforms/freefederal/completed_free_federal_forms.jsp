<%--
	Document : completed_free_federal_forms
...
<html>
    ...
    element.innerHTML = pagerHtml;
		...
		<div class="row">
		<div class="col-md-12">
		<div><font id="myAccountDocText">Completed - <font id="myAccountDocCategory">Free Federal Forms</font></font></div>
		...
		<div id="CompletedFreeFedFormsID" class="editUserProfile" style="display: none;">
		<a href="#"><font class="myAccountCurrentTab">&nbsp;Free Federal Forms&nbsp;</font></a> </div>
		
		<div id="CompletedNameAvaCheckID" class="pending-federal-form" style="display: none;">
		<a href="nameAvailabilityCheck"><font class="pendingfederal">&nbsp;Name Availability Check&nbsp;<font color="#00a9f1">-<c:out value="${completedNameAvaCheckCount}"/></font></font></a> </div>
		
		<div class="clearfix"></div>
		<div class="my-account-pending-stats">
		<form action="compFreeFederalFormsDataOperations" name="allStateFormsName" id="Documentform" method="get">		
		<h3 class="pending-head-text">Total completed free federal forms <span>: <b id="displayCount"></b>&nbsp;</span></h3>
		
		<div class="pendingfederal-box">				             
			<div class="table-wd-adjmnt">
			<display:table  id="insured_list"  class="tablesorter" name="compFreeFedFormSavingList">
            <display:column headerClass="sortDisabled">            
            <input type="radio" style=" cursor: pointer;" name="formName" value="${insured_list.userName},&, ${insured_list.stateName},&, ${insured_list.formName},&, ${insured_list.userChoice},&, ${insured_list.legalName},&, ${insured_list.formFederalDocumentsDataSavingId}"/>
            </display:column>
            ...
            <display:column property ="legalName" title="Legal Name &nbsp;" />
            </display:table></div>
		...
		<input type="hidden" name="allCompFreeFedFormsRefType"/>
		<div class="clearfix"></div>
		</div>
        ...
        var count = '<c:out value="${completedFreeFedFormsCount}"/>';        
        ...
        function orderInfo(){
            var formNames="";
            document.allStateFormsName.allCompFreeFedFormsRefType.value = "Order Info";
        ...
        function viewPDF(){
                var formNames="";
                document.allStateFormsName.allCompFreeFedFormsRefType.value = "View PDF";
                for(var k=0; k < document.allStateFormsName.formName.length; k++) {
                if(document.allStateFormsName.formName[k].checked){
                formNames=document.allStateFormsName.formName[k].value;        
                } } 
