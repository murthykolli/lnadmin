...
<html>
    ...
    element.innerHTML = pagerHtml;
		...
		<div class="row">
		<div class="col-md-12">
		<div><font id="myAccountDocText">Completed Federal Forms - <font id="myAccountDocCategory">Order Received</font></font></div>
		
		<div id="CompFederalFormsOrderReceivedID" class="editUserProfile" style="display: none;">
		...
		<form action="compAllFederalFormsOrderReceived" name="allFederalFormsName" id="Documentform" method="get">		
		...
		<div class="pendingfederal-box">				             
			...
			<display:table  id="insured_list"  class="tablesorter" name="compFederalFormSavingList">
            <display:column headerClass="sortDisabled">            
            <input type="radio" style=" cursor: pointer;" name="formName" value="${insured_list.userName},&, ${insured_list.legalName},&, ${insured_list.formStatus},&, ${insured_list.allFederalFormsCheckoutPaymentAndUserContactSavingId}"/>
            </display:column>
        ...
        var count = '<c:out value="${compFederalFormsOrderReceivedCount}"/>';        
        ...
        function orderInfo(){
        var formNames="";
        document.allFederalFormsName.allCompFederalFormsRefType.value = "Order Info";
        ...
        function viewPDF(){
            var formNames="";
            document.allFederalFormsName.allCompFederalFormsRefType.value = "View PDF";
            for(var k=0; k < document.allFederalFormsName.formName.length; k++) {
            if(document.allFederalFormsName.formName[k].checked){
            formNames=document.allFederalFormsName.formName[k].value;        
            } }        
        ...
        <c:if test="${not empty fedFormStatus}">    
