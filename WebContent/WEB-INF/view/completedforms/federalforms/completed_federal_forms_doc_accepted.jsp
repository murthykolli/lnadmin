<%--
	Document : completed_state_forms_doc_accepted
...
<html>
    ...
    element.innerHTML = pagerHtml;
		...
		<div class="row">
		<div class="col-md-12">
		<div><font id="myAccountDocText">Completed Federal Forms - <font id="myAccountDocCategory">Document Accepted</font></font></div>
		...
		<div id="CompFederalFormsDocAcceptedID" class="editUserProfile" style="display: none;">
		<a href="#"><font class="myAccountCurrentTab">&nbsp;Accepted&nbsp;</font></a> </div>
		...
		<form action="compFederalFormsDocAcceptedDataUpdate" name="allFederalFormsName" id="Documentform" method="get">		
		...
		<div class="pendingfederal-box">				             
			...
			<display:table  id="insured_list"  class="tablesorter" name="compFederalFormsDocAcceptedList">
		...
		<button class="white-bg-sub-but" type="submit" onclick="return docEmailed();" onMouseOver="document.getElementById('fcheout-sub-but').src='resources/images/SSImgs/RegPointerWhiteImg.png';" onMouseOut="document.getElementById('fcheout-sub-but').src='resources/images/SSImgs/RegPointerBlueImg.png';" ><img id="fcheout-sub-but" src="resources/images/SSImgs/RegPointerBlueImg.png" alt=""><span class="butt-va-mid">Doc Emailed</span></button> </h4>
        ...
        var count = '<c:out value="${compFederalFormsDocAcceptedCount}"/>';        
