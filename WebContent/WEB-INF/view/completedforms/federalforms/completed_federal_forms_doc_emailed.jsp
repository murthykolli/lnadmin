...
<html>
	...
	var compFederalFormsFileUploadCount = '<c:out value="${compFederalFormsFileUploadCount}"/>';	
	...
	if(compFederalFormsFileUploadCount > 0){ $("#CompFederalFormsFileUploadID").show(); }
    ...
    element.innerHTML = pagerHtml;
		...
		<div class="row">
		<div class="col-md-12">
		<div><font id="myAccountDocText">Completed Federal Forms - <font id="myAccountDocCategory">Document Mailed</font></font><font id="CompFederalFormsFileUploadID" style="display: none;float: right; font: bold 1.10em/1.25em Verdana,Geneva,Arial,Helvetica,sans-serif;"><img id="docimgPB1" src="resources/images/SSImgs/FileUplodImg.png" style="left: 0px;top: -4px;position:relative;" /><a href="compFedFormsUploadDataSaving" style=" cursor: pointer;text-decoration: none;outline: none;" ><font class="myAccountTab" style="left: 1px; top: -3px;position:relative;color:#393939;" onMouseOver="this.style.color='#00a9f1';document.getElementById('docimgPB1').src='resources/images/SSImgs/FileUplodMOImg.png';" onMouseOut="this.style.color='#393939';document.getElementById('docimgPB1').src='resources/images/SSImgs/FileUplodImg.png';" > File Upload Documents&nbsp;&nbsp;<font color="#00a9f1">-&nbsp;<c:out value="${compFederalFormsFileUploadCount}"/>&nbsp;</font></font></a></font></div>
		...
		<div class="pendingfederal-box">				             
			...
			<display:table  id="insured_list"  class="tablesorter" name="compFederalFormsDocEmailedList">
        ...
        var count = '<c:out value="${compFederalFormsDocEmailedCount}"/>';        
