...
<html>
    ...
    element.innerHTML = pagerHtml;
		...
		<div id="AdmStateFormsFileUploadID" class="pending-federal-form" style="display: none;">
		<a href="adminStateFormsFileupload"><font class="pendingfederal">&nbsp;State Forms File Upload Data&nbsp;<font color="#00a9f1">-<c:out value="${admStateFormsFileUploadCount}"/></font></font></a> </div>
		
		<div id="AdmFederalFormsFileUploadID" class="editUserProfile" style="display: none;">
		<a href="#"><font class="myAccountCurrentTab">&nbsp;Federal Forms File Upload Data&nbsp;</font></a> </div>
        ...
        var count = '<c:out value="${admFederalFormsFileUploadCount}"/>';        
