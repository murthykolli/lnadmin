...
<html>
    ...
    element.innerHTML = pagerHtml;
		...
		<div class="row">
		<div class="col-md-12">
		<div><font id="myAccountDocText">Completed Federal Forms - <font id="myAccountDocCategory">Signature</font></font></div>
		...
		<div id="CompFederalFormsSignatureID" class="editUserProfile" style="display: none;">
		...
		<form action="compFederalFormsSignatureDataUpdate" name="allFederalFormsName" id="Documentform" method="get">		
		...
		<div class="pendingfederal-box">				             
			...
			<display:table  id="insured_list"  class="tablesorter" name="compFederalFormsSignatureList">
        ...
        var count = '<c:out value="${compFederalFormsSignatureCount}"/>';        
