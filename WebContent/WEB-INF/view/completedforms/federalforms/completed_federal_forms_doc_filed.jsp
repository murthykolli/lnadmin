<%--
	Document : completed_state_forms_doc_filed
...
<html>
    ...
    element.innerHTML = pagerHtml;
		...
		<div class="row">
		<div class="col-md-12">
		<div><font id="myAccountDocText">Completed Federal Forms - <font id="myAccountDocCategory">Document Filed</font></font></div>
		...
		<div id="CompFederalFormsDocFiledID" class="editUserProfile" style="display: none;">
		<a href="#"><font class="myAccountCurrentTab">&nbsp;Filed&nbsp;</font></a> </div>
		...
		<form action="compFederalFormsDocFiledDataUpdate" name="allFederalFormsName" id="Documentform" method="get">		
		...
		<div class="pendingfederal-box">				             
			...
			<display:table  id="insured_list"  class="tablesorter" name="compFederalFormsDocFiledList">
		...
		<button class="white-bg-sub-but" type="submit" onclick="return docAccepted();" onMouseOver="document.getElementById('fcheout-sub-but').src='resources/images/SSImgs/RegPointerWhiteImg.png';" onMouseOut="document.getElementById('fcheout-sub-but').src='resources/images/SSImgs/RegPointerBlueImg.png';" ><img id="fcheout-sub-but" src="resources/images/SSImgs/RegPointerBlueImg.png" alt=""><span class="butt-va-mid">Doc Accepted</span></button> </h4>
        ...
        var count = '<c:out value="${compFederalFormsDocFiledCount}"/>';        
