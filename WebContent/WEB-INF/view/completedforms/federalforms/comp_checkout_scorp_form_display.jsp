<%--
    Document   : federal_checkout_s_corp_form_display
...
<html>    
    ...
    <link rel="stylesheet" type="text/css" href="resources/css/nicebuttonsdisplay.css" />    
		...
		<%
	        ...
	        ArrayList attNamesCorpList = (ArrayList) session.getAttribute("SCorp_Attr_Names_CheckOutList");
	        if (null != attNamesCorpList && attNamesCorpList.size() > 0) {
	        	
	        if (null != session.getAttribute("SCorp_Attr_Values_CheckOutList")) {
	        ArrayList attValueCorpList = (ArrayList) session.getAttribute("SCorp_Attr_Values_CheckOutList");
		...
		<div style="margin-top: -25px; margin-left: 0px;">
			<form action="compCheckoutSCorpFormsOrderDisplay" name="compDocmentName" method="get" id="pro-form">
            <h4 class="pull-left">		            
