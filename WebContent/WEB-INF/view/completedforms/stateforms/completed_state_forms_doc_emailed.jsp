<%--
	Document : completed_state_forms_doc_emailed
...
<html>
	...
	var compStateFormsFileUploadCount = '<c:out value="${compStateFormsFileUploadCount}"/>';	
	...
	if(compStateFormsFileUploadCount > 0){ $("#CompStateFormsFileUploadID").show(); }
    ...
    element.innerHTML = pagerHtml;
		...
		<div class="row">
		<div class="col-md-12">
		<div><font id="myAccountDocText">Completed State Forms - <font id="myAccountDocCategory">Document Mailed</font></font><font id="CompStateFormsFileUploadID" style="display: none;float: right; font: bold 1.10em/1.25em Verdana,Geneva,Arial,Helvetica,sans-serif;"><img id="docimgPB1" src="resources/images/SSImgs/FileUplodImg.png" style="left: 0px;top: -4px;position:relative;" /><a href="compStateFormsUploadDataSaving" style=" cursor: pointer;text-decoration: none;outline: none;" ><font class="myAccountTab" style="left: 1px; top: -3px;position:relative;color:#393939;" onMouseOver="this.style.color='#00a9f1';document.getElementById('docimgPB1').src='resources/images/SSImgs/FileUplodMOImg.png';" onMouseOut="this.style.color='#393939';document.getElementById('docimgPB1').src='resources/images/SSImgs/FileUplodImg.png';" > File Upload Documents&nbsp;&nbsp;<font color="#00a9f1">-&nbsp;<c:out value="${compStateFormsFileUploadCount}"/>&nbsp;</font></font></a></font></div>
		...
		<a href="#"><font class="myAccountCurrentTab">&nbsp;Mailed&nbsp;</font></a> </div>
		
		<div class="clearfix"></div>
		<div class="my-account-pending-stats">
		<form action="compStateFormsDocEmailedDataUpdate" name="allStateFormsName" id="Documentform" method="get">		
		...
		<div class="pendingfederal-box">				             
			...
			<display:table  id="insured_list"  class="tablesorter" name="compStateFormsDocEmailedList">
		...
		<button class="white-bg-sub-but" type="submit" onclick="return fileUpload();" onMouseOver="document.getElementById('fcheout-sub-but').src='resources/images/SSImgs/RegPointerWhiteImg.png';" onMouseOut="document.getElementById('fcheout-sub-but').src='resources/images/SSImgs/RegPointerBlueImg.png';" ><img id="fcheout-sub-but" src="resources/images/SSImgs/RegPointerBlueImg.png" alt=""><span class="butt-va-mid">File Upload</span></button> </h4>
        ...
        var count = '<c:out value="${compStateFormsDocEmailedCount}"/>';        
