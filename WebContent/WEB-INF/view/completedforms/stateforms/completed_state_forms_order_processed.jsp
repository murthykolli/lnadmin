...
<html>
    ...
    element.innerHTML = pagerHtml;
		...
		<div class="row">
		<div class="col-md-12">
		<div><font id="myAccountDocText">Completed State Forms - <font id="myAccountDocCategory">Order Processed</font></font></div>
		...
		<div id="CompStateFormsOrderProcessedID" class="editUserProfile" style="display: none;">
		...
		<form action="compStateFormsOrderProcessedDataUpdate" name="allStateFormsName" id="Documentform" method="get">		
		...
		<div class="pendingfederal-box">				             
			...
			<display:table  id="insured_list"  class="tablesorter" name="compStateFormsOrderProcessedList">
