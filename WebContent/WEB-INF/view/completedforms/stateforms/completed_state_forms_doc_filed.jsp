...
<html>
    ...
    element.innerHTML = pagerHtml;
		...
		<div class="row">
		<div class="col-md-12">
		<div><font id="myAccountDocText">Completed State Forms - <font id="myAccountDocCategory">Document Filed</font></font></div>
		...
		<div id="CompStateFormsDocFiledID" class="editUserProfile" style="display: none;">
		...
		<form action="compStateFormsDocFiledDataUpdate" name="allStateFormsName" id="Documentform" method="get">		
		...
		<div class="pendingfederal-box">				             
			...
			<display:table  id="insured_list"  class="tablesorter" name="compStateFormsDocFiledList">
        ...
        var count = '<c:out value="${compStateFormsDocFiledCount}"/>';        
