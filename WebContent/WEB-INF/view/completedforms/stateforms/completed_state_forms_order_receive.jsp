<%--
	Document : completed_state_forms
...
<html>
	...
	var pdfDocumentsCpont = '<c:out value="${pdfDocumentsCpont}"/>';	
	...
	if(pdfDocumentsCpont == "No"){ alert("PDF functionality not completed for this Document"); }
    ...
    element.innerHTML = pagerHtml;
		...
		<div class="row">
		<div class="col-md-12">
		<div><font id="myAccountDocText">Completed State Forms - <font id="myAccountDocCategory">Order Received</font></font></div>
		
		<div id="CompStateFormsOrderReceivedID" class="editUserProfile" style="display: none;">
		<a href="#"><font class="myAccountCurrentTab">&nbsp;Received&nbsp;</font></a> </div>
		...
		<form action="compAllStateFormsOrderReceived" name="allStateFormsName" id="Documentform" method="get">		
		...
		<div class="pendingfederal-box">				             
			...
			<display:table  id="insured_list"  class="tablesorter" name="compStateFormSavingList">
            <display:column headerClass="sortDisabled">            
            <input type="radio" style=" cursor: pointer;" name="formName" value="${insured_list.userName},&, ${insured_list.stateName},&, ${insured_list.formName},&, ${insured_list.userChoice},&, ${insured_list.typeOfDocument},&, ${insured_list.allStateFormsCheckoutPaymentAndUserContactSavingId}"/>
            </display:column>
		...
		<div align="center" style="margin-top: 50px;margin-left: 140px;">
		...
		<h4 class="pull-left btnn3">		            
		<button class="white-bg-sub-but" type="submit" onclick="return viewPDF();" onMouseOver="document.getElementById('viewpdf-sub-but').src='resources/images/SSImgs/ViewPDFMOImage.png';" onMouseOut="document.getElementById('viewpdf-sub-but').src='resources/images/SSImgs/ViewPDFImage.png';" ><img id="viewpdf-sub-but" src="resources/images/SSImgs/ViewPDFImage.png" alt=""><span class="butt-va-mid">View PDF</span></button> </h4>
		
		<h4 class="pull-left btnn3">		            
		<button class="white-bg-sub-but" type="submit" onclick="return orderProcessed();" onMouseOver="document.getElementById('fcheout-sub-but').src='resources/images/SSImgs/RegPointerWhiteImg.png';" onMouseOut="document.getElementById('fcheout-sub-but').src='resources/images/SSImgs/RegPointerBlueImg.png';" ><img id="fcheout-sub-but" src="resources/images/SSImgs/RegPointerBlueImg.png" alt=""><span class="butt-va-mid">Order Processed</span></button> </h4>
        ...
        var count = '<c:out value="${compStateFormsOrderReceivedCount}"/>';        
        ...
        function orderInfo(){
        var formNames="";
        document.allStateFormsName.allCompStateFormsRefType.value = "Order Info";
        ...
        function viewPDF(){
            var formNames="";
            document.allStateFormsName.allCompStateFormsRefType.value = "View PDF";
            for(var k=0; k < document.allStateFormsName.formName.length; k++) {
            if(document.allStateFormsName.formName[k].checked){
            formNames=document.allStateFormsName.formName[k].value;        
            } }        
        ...
        <c:if test="${not empty stFormStatus}">    
    	<script type="text/javascript"> window.alert("This document already processed!"); </script>
    	</c:if>         
