<%--
    Document   : comp_checkout_state_form_display
...
<html>    
    ...
    <link rel="stylesheet" type="text/css" href="resources/css/nicebuttonsdisplay.css" />    
		...
		<%
			if(null != session.getAttribute("Attr_SF_Names_CheckOutList")) {
	        ArrayList attNamesCorpList = (ArrayList) session.getAttribute("Attr_SF_Names_CheckOutList");
	        if (null != attNamesCorpList && attNamesCorpList.size() > 0) {
	        	
	        if(null != session.getAttribute("Attr_SF_Values_CheckOutList")) {
	        ArrayList attValueCorpList = (ArrayList) session.getAttribute("Attr_SF_Values_CheckOutList");
		...
		<div style="margin-top: -25px; margin-left: 0px;">
			<form action="compCheckoutStateFormsOrderDisplay" name="compDocmentName" method="get" id="pro-form">
            <h4 class="pull-left">		            
