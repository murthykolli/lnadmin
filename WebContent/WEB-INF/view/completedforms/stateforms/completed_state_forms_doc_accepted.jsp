...
<html>
    ...
    element.innerHTML = pagerHtml;
		...
		<div class="row">
		<div class="col-md-12">
		<div><font id="myAccountDocText">Completed State Forms - <font id="myAccountDocCategory">Document Accepted</font></font></div>
		...
		<div id="CompStateFormsDocAcceptedID" class="editUserProfile" style="display: none;">
		...
		<form action="compStateFormsDocAcceptedDataUpdate" name="allStateFormsName" id="Documentform" method="get">		
		...
		<div class="pendingfederal-box">				             
			...
			<display:table  id="insured_list"  class="tablesorter" name="compStateFormsDocAcceptedList">
        ...
        var count = '<c:out value="${compStateFormsDocAcceptedCount}"/>';        
