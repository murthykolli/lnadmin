<%--
	Document : completed_forms_header
		  ...
		  <div class="container">
		    <div class="collapse navbar-collapse js-navbar-collapse pull-right">
		      <ul id="menu" class="nav navbar-nav">
		        ...
		        <li class="dropdown active"> <a href="completedForms" class="dropdown-toggle">COMPLETED FORMS </a> <span data-toggle="dropdown" class="caret"></span>
