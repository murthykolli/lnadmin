		  ...
		  <div class="container">
		    <div class="collapse navbar-collapse js-navbar-collapse pull-right">
		      <ul id="menu" class="nav navbar-nav">
		        ...
		        <li> <a href="reportsHome">REPORTS</a> </li>
		        
		        <li class="dropdown active"> <a href="subAdminInfo" class="dropdown-toggle">SUB ADMIN</a> <span data-toggle="dropdown" class="caret"></span>
		          <ul class="dropdown-menu-subadm-sf subadmn-fm">		                  
		                  <li><a href="subAdminActiveUsers" >Active Users</a></li>
        				  <li><a href="subAdminInactiveUsers" >Inactive Users</a></li>		                		            
		          </ul>		        
		        </li>
