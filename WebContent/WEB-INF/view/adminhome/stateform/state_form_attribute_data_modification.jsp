<%--
	Document : state_form_attribute_data_modification
 ...
 /* State and Form selection code */ 
    	...
    	function newAjaxFormCall(selectedstate){    		
        	$.ajax({
    			...
    			cache: false,
    			success : function(result) {    				
    				window.location.href = "jSonStateFormsAttrDataDisplay";    				
    			} }); }    	
    </script>
    </head>
    	<body>    
		...
		<div>
		<div><font id="myAccountDocText">State Forms - <font id="myAccountDocCategory">Attributes Modification</font></font></div>
        ...
        <%    
        if (null != session.getAttribute("State_Forms_Attr_Info_ID_List")) {
        ArrayList attrInfoIdList = (ArrayList) session.getAttribute("State_Forms_Attr_Info_ID_List");
        if (null != attrInfoIdList && attrInfoIdList.size() > 0) {
        	
        if (null != session.getAttribute("State_Forms_Attr_Field_Names_List")) {
        ArrayList attrFieldNamesList = (ArrayList) session.getAttribute("State_Forms_Attr_Field_Names_List");
