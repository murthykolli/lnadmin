<%--
	Document : pending_free_federal_forms
...
<html>
    ...
    element.innerHTML = pagerHtml;
		...
		<div class="row">
		<div class="col-md-12">
		<div><font id="myAccountDocText">Pending - <font id="myAccountDocCategory">Free Federal Forms</font></font></div>
		
		<div id="PendingStateFormsID" class="pending-federal-form" style="display: none;">
		<a href="pendingStateForms"><font class="pendingfederal">&nbsp;State Forms&nbsp;<font color="#00a9f1">-&nbsp;<c:out value="${pendStateFormsCount}"/>&nbsp;</font></font></a> </div>
		...
		<div id="PendingFreeFedFormsID" class="editUserProfile" style="display: none;">
		<a href="#"><font class="myAccountCurrentTab">&nbsp;Free Federal Forms&nbsp;</font></a> </div>
		
		<div class="clearfix"></div>
		<div class="my-account-pending-stats">
		<form action="allFreeFederalFormsDataOperations" name="allStateFormsName" id="Documentform" method="get">		
		<h3 class="pending-head-text">Total free pending federal forms <span>: <b id="displayCount"></b>&nbsp;</span></h3>
		
		<div class="pendingfederal-box">				             
			<div class="table-wd-adjmnt">
			<display:table  id="insured_list"  class="tablesorter" name="pendFreeFedFormSavingList">
            <display:column headerClass="sortDisabled">            
            <input type="radio" style=" cursor: pointer;" name="formName" value="${insured_list.userName},&, ${insured_list.stateName},&, ${insured_list.formName},&, ${insured_list.userChoice},&, ${insured_list.legalName}"/>
            </display:column>
		...
		<div align="center" style="margin-top: 50px;margin-left: 330px;">
        ...
        var count = '<c:out value="${pendingFreeFedFormsCount}"/>';        
