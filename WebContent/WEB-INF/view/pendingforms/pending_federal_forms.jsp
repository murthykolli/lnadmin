...
<%--
    Document   : pending_federal_forms
...
<html>
    ...
    window.alert(sentData); 
		...
		<div class="row">
		<div class="col-md-12">
		<div><font id="myAccountDocText">Pending - <font id="myAccountDocCategory">Federal Forms</font></font></div>
		...
		<a href="#"><font class="myAccountCurrentTab">&nbsp;Federal Forms&nbsp;</font></a> </div>
		...
		<div class="pendingfederal-box">				             
            ...
            <input type="radio" style=" cursor: pointer;" onclick="changeColor(this);" name="documentsComb" value="${insured_list.userName},&, ${insured_list.typeOfDocument},&, ${insured_list.documentName}"/>
            </display:column>
        ...
        var count = '<c:out value="${pendingFedFormsCount}"/>';        
        ...
        function orderInfo(){
            var documentsCombs="";
            document.allFederalFormsName.allFederalFormsRefType.value = "OrderInfo";
        ...
        function emailSending(){
            var documentsCombs="";
            document.allFederalFormsName.allFederalFormsRefType.value = "EmailSend";
            for(var k=0; k < document.allFederalFormsName.documentsComb.length; k++) {
            if(document.allFederalFormsName.documentsComb[k].checked){
            documentsCombs=document.allFederalFormsName.documentsComb[k].value;
            } }        
