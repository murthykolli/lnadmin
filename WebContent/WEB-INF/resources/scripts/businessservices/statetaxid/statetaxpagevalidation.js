    ...
    function save(){
    var flag; var status = ""; var res = true;
    var boxes = $(".box");
    var tabClass = $(".tab");
    ...
    else if($c === 17){ flag = validation("form-table18");}
    else if($c === 18){ flag = validation("form-table19");}
    else if($c === 19){ flag = validation("form-table20");}
    else if($c === 20){ flag = validation("form-table21");}
    else if($c === 21){ flag = validation("form-table22");}
    else if($c === 22){ flag = validation("form-table23");}
    else if($c === 23){ flag = validation("form-table24");}
    else if($c === 24){ flag = validation("form-table25");}
    else if($c === 25){ flag = validation("form-table26");}
    else if($c === 26){ flag = validation("form-table27");}
    else if($c === 27){ flag = validation("form-table28");}
    else if($c === 28){ flag = validation("form-table29");}
    if(flag === true){
