    ...
    $("#radio2").click(function(){ $(".saddr").hide();
    document.federaltax.attributeTextField6.value = "";document.federaltax.attributeTextField7.value = "";
    document.federaltax.attributeTextField8.value = "";document.federaltax.attributeSelectBox1.value = "";
    document.federaltax.attributeTextField42.value = "";
    });
    $("#radio3").click(function(){$(".llc").show();});
    $("#radio4").click(function(){
    $(".llc").hide();document.federaltax.attributeTextField16.value = "";
    document.federaltax.radioButton3[0].checked = false;document.federaltax.radioButton3[1].checked = false;
    });
    ...
    $(".hire").hide();document.federaltax.checkBox1.checked = false;});
    ...
    if($c === 0){
    flag = validation("form-div1"); $("input[name='federalFormPageValues']").val("form-div2");
    } else if($c === 1){
    flag = validation("form-div2"); $("input[name='federalFormPageValues']").val("form-div3");
    } else if($c === 2){
    flag = validation("form-div3"); $("input[name='federalFormPageValues']").val("form-div4");
    } else if($c === 3){
    flag = validation("form-div4"); $("input[name='federalFormPageValues']").val("form-div4");
    $("input[name='federalDocFinishOrderRef']").val("Finished");
    }
    if(flag === true){
    if($("input[name='attributeTextField1']").val() !== ""){newAjaxCall();result = choiceRet;}
    if(result === true){ $("form[name='federaltax']").submit(); }
    }
    return false;
    }